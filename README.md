...
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| **Peculiar ORM**       | A lightweight, transparent, and resilient PostgreSQL ORM built with TypeScript. Designed for microservices with explicit transaction control, repository pattern, rich observability (connection pooling metrics, query performance, transaction lifecycles), and first-class support for Inversify dependency injection. Zero-bloat wrapper around `pg` with graceful handling of connection drops and query timeouts. | TypeScript, PostgreSQL, Node.js, pg, Inversify, Reflect-Metadata                         |
| **Node_be_v2**         | A production-ready Node.js backend starter template engineered around clean architecture and scalability. Ships with opinionated project structure, dependency injection, transaction-safe database access, observability hooks, environment-based configuration, and CI/CD readiness. Acts as a foundation for rapidly building FinTech and backend-heavy systems.                                                     | TypeScript, Node.js, Express/Nest-style Architecture, PostgreSQL, Docker, GitHub Actions |
| **Agentic Accountant** | (Concept) A personal finance tool that acts as an AI agent, providing autonomous insights and predictive budget reports.                                                                                                                                                                                                                                                                                                | Python, AI Agents, Data Analysis, TypeScript, React, C#, Node.js, PostgreSQL             |
| **GiftFlex**           | A full-stack gift wishlisting and fulfillment marketplace designed so people can show and receive love more thoughtfully.                                                                                                                                                                                                                                                                                               | TypeScript, React, Node.js (Express), PostgreSQL                                         |
| **Sprauwt**            | Personal tool used to manage budgets across multiple financial profiles and portfolios.                                                                                                                                                                                                                                                                                                                                 | Lovable, Windsurf, Node.js, Express, PostgreSQL, React                                   |
